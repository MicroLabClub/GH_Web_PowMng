  ...
  async function getMessages() {
    try {
      ...
      setMessagesPower({
        ...
        datasets: { label: "Power", data: shortResult.map(x => JSON.parse(x.message).chargingPower) },
      });
      ...
      setMessagesPVoltage({
        ...
        datasets: { label: "PV Voltage", data: shortResult.map(x => JSON.parse(x.messagePVoltage).pVoltage) },
      });
